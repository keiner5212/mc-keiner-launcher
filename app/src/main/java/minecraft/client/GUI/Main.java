...
import minecraft.client.entities.LegacySession;
...
public class Main extends javax.swing.JFrame {
        ...
        public Main() {
                ...
                if (userJson.containsKey("username")) {
                        ...
                        session = new LegacySession(userJson.get("username").toString());
                } else {
                        String userName = System.getProperty("user.name");
                        username.setText(userName);
                        session = new LegacySession(userName);
                }
    ...
    private void initComponents() {
        ...
        instalations_and_nameLayout.setHorizontalGroup(
            ...
            .addGroup(instalations_and_nameLayout.createSequentialGroup()
                ...
                .addGroup(instalations_and_nameLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(loaderlabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        play_downloadLayout.setHorizontalGroup(
            ...
            .addGroup(play_downloadLayout.createSequentialGroup()
                .addGap(45, 45, 45)
                .addGroup(play_downloadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(play_downloadLayout.createSequentialGroup()
                        .addGroup(play_downloadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(deleteinstalation)
                            .addGroup(play_downloadLayout.createSequentialGroup()
                                .addComponent(loaderlabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(instalationname, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(viewfiles))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, play_downloadLayout.createSequentialGroup()
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, play_downloadLayout.createSequentialGroup()
                                .addGroup(play_downloadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(jLabel3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(loaderlabel, javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(Loader, 0, 99, Short.MAX_VALUE))
                                .addGroup(play_downloadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(play_downloadLayout.createSequentialGroup()
                                        .addGap(45, 45, 45)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, play_downloadLayout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jvm, javax.swing.GroupLayout.PREFERRED_SIZE, 272, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        .addGroup(play_downloadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(loaderversion, javax.swing.GroupLayout.Alignment.TRAILING, 0, 122, Short.MAX_VALUE)
        ...
        play_downloadLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, play_downloadLayout.createSequentialGroup()
                .addGroup(play_downloadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(progresslabel, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE)
                    .addGroup(play_downloadLayout.createSequentialGroup()
                ...
                .addGroup(play_downloadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(play_downloadLayout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addGroup(play_downloadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(loaderlabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(instalationname, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(viewfiles))
                        .addGap(18, 18, 18)
                        .addComponent(deleteinstalation))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, play_downloadLayout.createSequentialGroup()
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(loggerscroll, javax.swing.GroupLayout.PREFERRED_SIZE, 255, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        private void playActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_playActionPerformed
                ...
                VersionDownloader versionDownloader = new VersionDownloader(Loader.getSelectedItem().toString(),
                                versions.getSelectedItem().toString(), loaderVersionSelected, mc,
                                installerLogger,
                                Integer.parseInt(memory.getSelectedItem().toString()) * 1024, session,
