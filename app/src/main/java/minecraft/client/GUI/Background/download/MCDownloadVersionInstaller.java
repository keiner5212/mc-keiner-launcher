...
import minecraft.client.entities.versions.IVersionInstallListener;
import minecraft.client.entities.versions.IVersionInstaller;
import minecraft.client.impl.common.Platform;
import minecraft.client.util.ExtractUtils;
import minecraft.client.util.FileUtils;
...
final class MCDownloadVersionInstaller implements IVersionInstaller {
    ...
    public MCDownloadVersionInstaller(JProgressBar progressBar, JLabel progressLabel) {
    ...
    public void install(IVersion v, MinecraftInstance mc, IProgressMonitor progress) throws Exception {
        if (progress == null)
            progress = new DummyProgressMonitor(progressBar, progressLabel);
